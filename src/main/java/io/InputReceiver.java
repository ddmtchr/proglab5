...
public class InputReceiver {
    ...
    private boolean fileReadMode;

    /**
     * Creates an instance of InputReceiver and sets user command input mode.
    ...
    /**
     * Set other scanner to this InputReceiver.
     * @param s Scanner to be set
     */
    ...
    /**
     * Get Scanner used now.
     * @return Scanner used now
     */
    ...
    private int enterX() throws ErrorInScriptException {
        ...
        while (true) {
            try {
                ...
                if (x <= -934) throw new NumberOutOfBoundsException();
                break;
    ...
    private float enterY() throws ErrorInScriptException {
        ...
        while (true) {
            try {
                ...
                if (y > 946) throw new NumberOutOfBoundsException();
                break;
            } catch (NumberOutOfBoundsException e) {
    ...
    private String enterName() throws ErrorInScriptException {
        ...
        while (true) {
            try {
                ...
                if (name.isBlank() || name.isEmpty()) throw new WrongInputFormatException();
                break;
    ...
    private int enterMinPoint() throws ErrorInScriptException {
        ...
        while (true) {
            try {
                ...
                if (fileReadMode) System.out.println(stringX);
                x = Integer.parseInt(stringX);
                if (x <= 0) throw new NumberOutOfBoundsException();
                break;
            } catch (NumberOutOfBoundsException e) {
    ...
    private String enterDisciplineName() {
        ...
        while (true) {
            try {
                ...
                if (disName.isBlank() || disName.isEmpty()) throw new WrongInputFormatException();
                break;
            } catch (WrongInputFormatException e) {
                return null;
            } catch (NoSuchElementException e) {
     ...
     * @throws ErrorInScriptException If the script contains an input format error
     */
    public LabWork enterLabWork() throws ErrorInScriptException {
        return new LabWork(enterName(),
                enterCoordinates(),
                enterMinPoint(),
                enterAveragePoint(),
                enterDifficulty(),
