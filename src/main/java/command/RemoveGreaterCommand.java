 ...
 */
class RemoveGreaterCommand implements Command {
     ...
     */
    public RemoveGreaterCommand(FileData data) {
        this.data = data;
    }
    ...
    public int execute(String args) {
        ...
        try {
            ...
            execCode = data.removeGreater();
        } catch (WrongCommandFormatException e) {
            execCode = 1;
            System.out.println("Использование: remove_greater");
        }
        return execCode;
    }
